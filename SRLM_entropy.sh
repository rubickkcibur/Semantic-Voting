...
python src/SRLM/entropy.py \
    ...
    --scored_path "/mnt/maclabcv2/rubickjiang/codes/open-r1/data/SR_candidates/Qwen2.5-1.5B-Instruct/wmt24pp_zh_entropy_scored.jsonl" \
    --dpo_path "/mnt/maclabcv2/rubickjiang/codes/open-r1/data/SR_candidates/Qwen2.5-1.5B-Instruct/wmt24pp_zh_entropy_dpo.jsonl" \
    --few_shot_cot False \
    --batch_size 8 \
    --max_model_len 3076 \
    --seed $SEED
