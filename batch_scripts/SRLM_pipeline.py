...
def compute_self_scores(base_model_name, dataset_name):
    ...
    command = [
        ...
        "--scored_path", "/mnt/{}/rubickjiang/codes/open-r1/data/SR_candidates/{}/{}_self_scored.jsonl".format(os.environ["MACLAB_NAS_NAME"], base_model_name, dataset_name),
        "--dpo_path", "/mnt/{}/rubickjiang/codes/open-r1/data/SR_candidates/{}/{}_self_dpo.jsonl".format(os.environ["MACLAB_NAS_NAME"], base_model_name, dataset_name),
        "--few_shot_cot", "False",
        "--batch_size", "4",
        "--return_sequences", "1",
        "--max_model_len", "3072",
...
def train(base_model_name, dataset_name):
    ...
    params["dataset_name"] = "/mnt/{}/rubickjiang/codes/open-r1/data/SR_candidates/{}/{}_self_dpo.jsonl".format(os.environ["MACLAB_NAS_NAME"], base_model_name, dataset_name)
    params["output_dir"] = "/mnt/{}/rubickjiang/codes/open-r1/data/self_models/{}-DPO-{}-self".format(os.environ["MACLAB_NAS_NAME"], base_model_name, dataset_name)
...
def evaluate(base_model_name, dataset_name):
    ...
    command = [
        ...
        "--model_name_or_path", "/mnt/{}/rubickjiang/codes/open-r1/data/self_models/{}-DPO-{}-self".format(os.environ["MACLAB_NAS_NAME"], base_model_name, dataset_name),
        "--tokenizer_path", "/mnt/{}/rubickjiang/proj_storage/huggingface_models/{}".format(os.environ["MACLAB_NAS_NAME"], base_model_name),
        "--output_dir", "",
        "--mode", "chat",
