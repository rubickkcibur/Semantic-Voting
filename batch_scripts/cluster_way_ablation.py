...
def train(base_model_name, dataset_name, variant):
    ...
    params["output_dir"] = "data/main_results/models/{}-DPO-{}-{}".format(base_model_name, dataset_name, variant)
...
def evaluate(base_model_name, dataset_name, variant, max_new_tokens=512):
    ...
    command = [
        ...
        "--model_name_or_path", "data/main_results/models/{}-DPO-{}-{}".format(base_model_name, dataset_name, variant),
