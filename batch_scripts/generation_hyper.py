...
def generate_sr_candidates(base_model_name, dataset_name, temperature, number):
    ...
    command = [
        ...
        "--tokenizer_path", "",
        "--output_dir", "/mnt/{}/rubickjiang/codes/open-r1/data/temperature/data/{}-tp{}-num{}".format(os.environ["MACLAB_NAS_NAME"], base_model_name, temperature, number),
        "--mode", "chat",
        "--dataset_name", dataset_name,
        "--few_shot_cot", "False",
        "--batch_size", "4",
        "--return_sequences", "{}".format(number),
...
def compute_cluster_scores(base_model_name, dataset_name, temperature, number):
    # Define the command to run the SRLM cluster scoring script
    command = [
        "nohup", "python", "src/SRLM/cluster_score.py",
        "--candidate_path", "/mnt/{}/rubickjiang/codes/open-r1/data/temperature/data/{}-tp{}-num{}/{}_output_{}.jsonl".format(os.environ["MACLAB_NAS_NAME"], base_model_name, temperature, number, dataset_name, number),
        "--output_path_scored_file", "/mnt/{}/rubickjiang/codes/open-r1/data/temperature/data/{}-tp{}-num{}/{}_scored.jsonl".format(os.environ["MACLAB_NAS_NAME"], base_model_name, temperature, number, dataset_name),
        "--output_path_dpo_file", "/mnt/{}/rubickjiang/codes/open-r1/data/temperature/data/{}-tp{}-num{}/{}_dpo.jsonl".format(os.environ["MACLAB_NAS_NAME"], base_model_name, temperature, number, dataset_name),
        "--min_cluster_size", "5",
        "--min_samples", "2",
        "--filter_length", "5",
        "--seed", "42"
...
def train(base_model_name, dataset_name, temperature, number):
    ...
    params["dataset_name"] = "/mnt/{}/rubickjiang/codes/open-r1/data/temperature/data/{}-tp{}-num{}/{}_dpo.jsonl".format(os.environ["MACLAB_NAS_NAME"], base_model_name, temperature, number, dataset_name)
    params["output_dir"] = "/mnt/{}/rubickjiang/codes/open-r1/data/temperature/model/{}-DPO-{}-tp{}-num{}".format(os.environ["MACLAB_NAS_NAME"], base_model_name, dataset_name, temperature, number)
...
def evaluate(base_model_name, dataset_name, temperature, number, max_new_tokens=512):
    ...
    command = [
        ...
        "--model_name_or_path", "/mnt/{}/rubickjiang/codes/open-r1/data/temperature/model/{}-DPO-{}-tp{}-num{}".format(os.environ["MACLAB_NAS_NAME"], base_model_name, dataset_name, temperature, number),
