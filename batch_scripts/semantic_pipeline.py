...
if __name__ == "__main__":
    ...
    searching_pairs = [
        ...
        ("Meta-Llama-3-8B-Instruct", "pubmed_summary"),
        # ("Meta-Llama-3-8B-Instruct", "wmt24pp_de_inv"),
        # ("Meta-Llama-3-8B-Instruct", "wmt24pp_fr_inv"),
        # ("Meta-Llama-3-8B-Instruct", "wmt24pp_ru_inv"),
        # ("Meta-Llama-3-8B-Instruct", "wmt24pp_es_inv"),
        # ("Qwen2.5-7B-Instruct", "wmt24pp_de_inv"),
        # ("Qwen2.5-7B-Instruct", "wmt24pp_fr_inv"),
        # ("Qwen2.5-7B-Instruct", "wmt24pp_ru_inv"),
        # ("Qwen2.5-7B-Instruct", "wmt24pp_es_inv"),
