...
def train(base_model_name, dataset_name, min_cluster_size=5, min_samples=2, emb=""):
    ...
    params["output_dir"] = "data/main_results/models/{}-DPO-{}-{}-{}-{}".format(base_model_name, dataset_name, min_cluster_size, min_samples, emb)
...
def evaluate(base_model_name, dataset_name, min_cluster_size=5, min_samples=2, max_new_tokens = 512, emb=""):
    ...
    command = [
        ...
        "--model_name_or_path", "data/main_results/models/{}-DPO-{}-{}-{}-{}".format(base_model_name, dataset_name, min_cluster_size, min_samples, emb),
