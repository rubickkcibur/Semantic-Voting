...
def train(base_model_name, dataset_name, min_cluster_size=5, min_samples=2):
    ...
    params["output_dir"] = "data/main_results/models/{}-DPO-{}-{}-{}-flipped".format(base_model_name, dataset_name, min_cluster_size, min_samples)
...
def evaluate(base_model_name, dataset_name, min_cluster_size=5, min_samples=2, max_new_tokens=512):
    ...
    command = [
        ...
        "--model_name_or_path", "data/main_results/models/{}-DPO-{}-{}-{}-flipped".format(base_model_name, dataset_name, min_cluster_size, min_samples),
