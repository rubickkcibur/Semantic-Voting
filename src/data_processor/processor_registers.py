from data_processor import wmt19_de, wmt19_ru, wmt14_es, wmt14_fr, wmt24pp_zh, wmt24pp_de, wmt24pp_fr, wmt24pp_ru, wmt24pp_es, cnn_dailymail, xsum, pubmed_summary, alpaca_eval, wmt24pp_de_inv, wmt24pp_es_inv, wmt24pp_fr_inv, wmt24pp_ru_inv
...
def load_custom_dataset(dataset_name: str, tokenizer: PreTrainedTokenizer = None, cot: bool = False, apply_chat_template: bool = False):
    dataset_registers = {
        ...
        "wmt24pp_de_inv": wmt24pp_de_inv.load_data,
        ...
        "wmt24pp_fr_inv": wmt24pp_fr_inv.load_data,
        "wmt24pp_ru": wmt24pp_ru.load_data,
        "wmt24pp_ru_inv": wmt24pp_ru_inv.load_data,
        "wmt24pp_es": wmt24pp_es.load_data,
        "wmt24pp_es_inv": wmt24pp_es_inv.load_data,
...
def get_metrics(dataset_name: str):
    metrics_registers = {
        ...
        "wmt24pp_de_inv": wmt24pp_de_inv.metric,
        ...
        "wmt24pp_fr_inv": wmt24pp_fr_inv.metric,
        "wmt24pp_ru": wmt24pp_ru.metric,
        "wmt24pp_ru_inv": wmt24pp_ru_inv.metric,
        "wmt24pp_es": wmt24pp_es.metric,
        "wmt24pp_es_inv": wmt24pp_es_inv.metric,
...
REPORT_METRICS = {
    ...
    "wmt24pp_de_inv": wmt24pp_de_inv.REPORT_METRICS,
    ...
    "wmt24pp_fr_inv": wmt24pp_fr_inv.REPORT_METRICS,
    "wmt24pp_ru": wmt24pp_ru.REPORT_METRICS,
    "wmt24pp_ru_inv": wmt24pp_ru_inv.REPORT_METRICS,
    "wmt24pp_es": wmt24pp_es.REPORT_METRICS,
    "wmt24pp_es_inv": wmt24pp_es_inv.REPORT_METRICS,
