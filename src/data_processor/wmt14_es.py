...
DATA_PATH="wmt14" # customize to local data path
COT_EXAMPLES_chat = [
...
SYSTEM_PROMPT = r"You are a translation assistant who carefully and thoughtfully translates Spanish sentences into English, ensuring that the translated sentences fluent and accurately convey the original meaning. Place your translation answer in \boxed{}. For axmaple, if the answer is 'Hello World', you should output \boxed{Hello World}.\n"
...
def reward_model_score(pred_txt, kwargs_list):
    ...
    with tqdm.tqdm(total=total_length, desc="Calculating MQM scores without reference") as pbar:
        for i in range(0, total_length, batch_size):
            ...
            batch_source = [kwarg["translation"]["es"] for kwarg in kwargs_list[i:i+batch_size]]
            batch_texts = [
