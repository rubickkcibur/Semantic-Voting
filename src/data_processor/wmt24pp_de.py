...
COT_EXAMPLES_chat = []
SYSTEM_PROMPT = r"You are a translation assistant who carefully and thoughtfully translates German sentences into English, ensuring that the translated sentences fluent and accurately convey the original meaning. Place your translation answer in \boxed{}. For axmaple, if the answer is 'Hello World', you should output \boxed{Hello World}.\n"
...
logger = logging.getLogger("MainLogger.wmt24pp_de")

def load_data(cot: bool = False):
    dataset = load_dataset(DATA_PATH, "en-de_DE")
