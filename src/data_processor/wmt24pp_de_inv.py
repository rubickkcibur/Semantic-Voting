...
COT_EXAMPLES_chat = []
SYSTEM_PROMPT = r"You are a translation assistant who carefully and thoughtfully translates English sentences into German, ensuring that the translated sentences fluent and accurately convey the original meaning. Place your translation answer in \boxed{}. For axmaple, if the answer is 'Hallo Welt', you should output \boxed{Hallo Welt}.\n"
...
logger = logging.getLogger("MainLogger.wmt24pp_de_inv")
