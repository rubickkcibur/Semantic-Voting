...
DATA_PATH="/mnt/{}/rubickjiang/public_dataset/wmt24pp".format(MACLAB_NAS_NAME)
COT_EXAMPLES_chat = []
...
logger = logging.getLogger("MainLogger.wmt24pp_es")

def load_data(cot: bool = False):
    dataset = load_dataset(DATA_PATH, "en-es_MX")
...
def metric(output_text, kwargs_list):
    ...
    refs = [kwargs["source"] for kwargs in kwargs_list]
