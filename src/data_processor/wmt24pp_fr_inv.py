...
COT_EXAMPLES_chat = []
SYSTEM_PROMPT = r"You are a translation assistant who carefully and thoughtfully translates English sentences into French, ensuring that the translated sentences fluent and accurately convey the original meaning. Place your translation answer in \boxed{}. For axmaple, if the answer is 'Bonjour le monde', you should output \boxed{Bonjour le monde}.\n"
...
logger = logging.getLogger("MainLogger.wmt24pp_fr_inv")

def load_data(cot: bool = False):
    dataset = load_dataset(DATA_PATH, "en-fr_FR")
