...
total_data = [
    ...
    ("Qwen-1.5B", "w/o. Cluster", cal_relative(Qwen_no_cluster, Qwen_base)),
    ("Qwen-1.5B", "w/o. SV", cal_relative(Qwen_no_SV, Qwen_base)),
    ("Llama-1B", "Ours", cal_relative(Llama_ours, Llama_base)),
    ("Llama-1B", "w/o. Cluster", cal_relative(Llama_no_cluster, Llama_base)),
...
for ax in g.axes.flat:
    for patch in ax.patches:
        ...
        cnt += 1
g.tight_layout()
plt.savefig("dpo_ablation.png", dpi=144, bbox_inches='tight')